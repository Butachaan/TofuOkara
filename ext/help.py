...
class help(commands.Cog):
    ...
    async def helps(self, ctx):
        ...
        while True:
            if first_run:
                page1 = discord.Embed(title='Page 1/7', description='Description1',  color=0x00aaff)
            ...
            if user != ctx.message.author:
                ...
                print('<<2️⃣>>')
                page2 = discord.Embed(title='Page 2/7', description='prefix:[y/]', color=0x00aaff)
                ...
                print('<<3️⃣>>')
                page3 = discord.Embed(title='Page 3/7', description='prefix:[y/]', color=0x00aaff)
                ...
                print('<<4⃣>>')
                page4 = discord.Embed(title='Page 4/7', description='prefix:[y/]', color=0x00aaff)
                ...
                print('<<5⃣>>')
                page5 = discord.Embed(title='Page 5/7', description='prefix:[y/]',color=0x00aaff)
                ...
                print('<<6⃣>>')
                page6 = discord.Embed(title="Page 6/7", description="prefix:[y/]", color=0x00aaff)
                ...
                print('<<7⃣>>')
                page7 = discord.Embed(title="Page 7/7", description="prefix:[y/]",color=0x00aaff)
